...
extern "C"
{
	...
	void	_adWhirlInit();
	void	_adWhirlIgnoreAutoRefreshTimer();
	void	_adWhirlCreateBanner();
	void	_adWhirlDestroyBanner();
	void	_adWhirlSetTestMode();
	void	_adWhirlSendAdDelegateCalls();
	void	_gameCenterIsGameCenterAvailable();
	void	_gameCenterAuthenticateLocalPlayer();
	void	_gameCenterIsPlayerAuthenticated();
	void	_gameCenterPlayerAlias();
	void	_gameCenterPlayerIdentifier();
	void	_gameCenterIsUnderage();
	void	_gameCenterRetrieveFriends();
	void	_gameCenterLoadPlayerData();
	void	_gameCenterLoadProfilePhotoForLocalPlayer();
	void	_gameCenterLoadLeaderboardLeaderboardTitles();
	void	_gameCenterReportScore();
	void	_gameCenterIssueScoreChallenge();
	void	_gameCenterShowLeaderboardWithTimeScope();
	void	_gameCenterShowLeaderboardWithTimeScopeAndLeaderboardId();
	void	_gameCenterRetrieveScores();
	void	_gameCenterRetrieveScoresForLeaderboard();
	void	_gameCenterRetrieveScoresForPlayerId();
	void	_gameCenterRetrieveScoresForPlayerIdAndLeaderboard();
	void	_gameCenterReportAchievement();
	void	_gameCenterSelectChallengeablePlayerIDsForAchievement();
	void	_gameCenterIssueAchievementChallenge();
...
void RegisterMonoModules()
{
	...
	mono_dl_register_symbol("_adWhirlInit", (void*)&_adWhirlInit);
	mono_dl_register_symbol("_adWhirlIgnoreAutoRefreshTimer", (void*)&_adWhirlIgnoreAutoRefreshTimer);
	mono_dl_register_symbol("_adWhirlCreateBanner", (void*)&_adWhirlCreateBanner);
	mono_dl_register_symbol("_adWhirlDestroyBanner", (void*)&_adWhirlDestroyBanner);
	mono_dl_register_symbol("_adWhirlSetTestMode", (void*)&_adWhirlSetTestMode);
	mono_dl_register_symbol("_adWhirlSendAdDelegateCalls", (void*)&_adWhirlSendAdDelegateCalls);
	mono_dl_register_symbol("_gameCenterIsGameCenterAvailable", (void*)&_gameCenterIsGameCenterAvailable);
	mono_dl_register_symbol("_gameCenterAuthenticateLocalPlayer", (void*)&_gameCenterAuthenticateLocalPlayer);
	mono_dl_register_symbol("_gameCenterIsPlayerAuthenticated", (void*)&_gameCenterIsPlayerAuthenticated);
	mono_dl_register_symbol("_gameCenterPlayerAlias", (void*)&_gameCenterPlayerAlias);
	mono_dl_register_symbol("_gameCenterPlayerIdentifier", (void*)&_gameCenterPlayerIdentifier);
	mono_dl_register_symbol("_gameCenterIsUnderage", (void*)&_gameCenterIsUnderage);
	mono_dl_register_symbol("_gameCenterRetrieveFriends", (void*)&_gameCenterRetrieveFriends);
	mono_dl_register_symbol("_gameCenterLoadPlayerData", (void*)&_gameCenterLoadPlayerData);
	mono_dl_register_symbol("_gameCenterLoadProfilePhotoForLocalPlayer", (void*)&_gameCenterLoadProfilePhotoForLocalPlayer);
	mono_dl_register_symbol("_gameCenterLoadLeaderboardLeaderboardTitles", (void*)&_gameCenterLoadLeaderboardLeaderboardTitles);
	mono_dl_register_symbol("_gameCenterReportScore", (void*)&_gameCenterReportScore);
	mono_dl_register_symbol("_gameCenterIssueScoreChallenge", (void*)&_gameCenterIssueScoreChallenge);
	mono_dl_register_symbol("_gameCenterShowLeaderboardWithTimeScope", (void*)&_gameCenterShowLeaderboardWithTimeScope);
	mono_dl_register_symbol("_gameCenterShowLeaderboardWithTimeScopeAndLeaderboardId", (void*)&_gameCenterShowLeaderboardWithTimeScopeAndLeaderboardId);
	mono_dl_register_symbol("_gameCenterRetrieveScores", (void*)&_gameCenterRetrieveScores);
	mono_dl_register_symbol("_gameCenterRetrieveScoresForLeaderboard", (void*)&_gameCenterRetrieveScoresForLeaderboard);
	mono_dl_register_symbol("_gameCenterRetrieveScoresForPlayerId", (void*)&_gameCenterRetrieveScoresForPlayerId);
	mono_dl_register_symbol("_gameCenterRetrieveScoresForPlayerIdAndLeaderboard", (void*)&_gameCenterRetrieveScoresForPlayerIdAndLeaderboard);
	mono_dl_register_symbol("_gameCenterReportAchievement", (void*)&_gameCenterReportAchievement);
	mono_dl_register_symbol("_gameCenterSelectChallengeablePlayerIDsForAchievement", (void*)&_gameCenterSelectChallengeablePlayerIDsForAchievement);
	mono_dl_register_symbol("_gameCenterIssueAchievementChallenge", (void*)&_gameCenterIssueAchievementChallenge);
	mono_dl_register_symbol("_gameCenterGetAchievements", (void*)&_gameCenterGetAchievements);
	mono_dl_register_symbol("_gameCenterResetAchievements", (void*)&_gameCenterResetAchievements);
	mono_dl_register_symbol("_gameCenterShowAchievements", (void*)&_gameCenterShowAchievements);
	mono_dl_register_symbol("_gameCenterRetrieveAchievementMetadata", (void*)&_gameCenterRetrieveAchievementMetadata);
	mono_dl_register_symbol("_gameCenterShowCompletionBannerForAchievements", (void*)&_gameCenterShowCompletionBannerForAchievements);
#endif // !(TARGET_IPHONE_SIMULATOR)
}
...
int RegisterClass_ParticleSystem();
 RegisterClass_ParticleSystem();
int RegisterClass_ParticleSystemRenderer();
